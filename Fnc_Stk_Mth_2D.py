...
def Cosmo_Scale_Par(z_cosmo_parm,Uni_Cosmo_Pars,*args, **kwargs):
	...
	rad_vel_sep = 3000
	rad_sep = 5
	scale  = (1/Uni_Cosmo_Pars.arcsec_per_kpc_proper(z_cosmo_parm)) 
	scaleL = Uni_Cosmo_Pars.luminosity_distance(z_cosmo_parm) 
	...
	if cosmo_check == True:
		...
		print ('Angular distance scale                           : ', scale) 
		print ('The angular separations [kpc]                    : ', sepkpc.value)
		print ('Luminosity distance(D_L)                         : ', scaleL)
		print ('')
